...
console.log('This script populates your db with authors, genres, books, and book instances. Specify db connection url as arg (e.g. node populatedb-revised.js mongodb+srv://db-username:db-password@cluster0.uwwlz8f.mongodb.net/local-library?retryWrites=true&w=majority');
